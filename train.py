...
def main(args):
    ...
    test_datasets = datasets[config["dataset_type"]](**config["dataset"],tokenizer = net.tokenizer,data_type = "test")
    valid_datasets = datasets[config["dataset_type"]](**config["dataset"],tokenizer = net.tokenizer,data_type = "valid")
